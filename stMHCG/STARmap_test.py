...
def load_data(dataset):
    print("load data:")
    path = "../generate_data/STARmap/" + dataset + "/stMHCG.h5ad"
...
if __name__ == "__main__":
    ...
    for i in range(len(datasets)):
        ...
        sc.tl.umap(adata)
        sc.pl.umap(adata, color='idx')
        plt.rcParams["figure.figsize"] = (4, 2)
        sc.pl.embedding(adata, basis="spatial", color='idx', s=20, title=title,show=False)
